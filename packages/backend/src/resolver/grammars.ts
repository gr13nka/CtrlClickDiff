...
export const GRAMMARS: Readonly<Record<string, GrammarAssets>> = {
  ...
  javascript: {
    wasmPath: resolvePath(REPO_ROOT, 'vendor/tree-sitter-javascript.wasm'),
    tagsScmPath: resolvePath(here, 'tags/javascript.scm'),
  },
  python: {
    wasmPath: resolvePath(REPO_ROOT, 'vendor/tree-sitter-python.wasm'),
    tagsScmPath: resolvePath(here, 'tags/python.scm'),
  },
  java: {
    wasmPath: resolvePath(REPO_ROOT, 'vendor/tree-sitter-java.wasm'),
    tagsScmPath: resolvePath(here, 'tags/java.scm'),
  },
  go: {
    wasmPath: resolvePath(REPO_ROOT, 'vendor/tree-sitter-go.wasm'),
    tagsScmPath: resolvePath(here, 'tags/go.scm'),
  },
  rust: {
  ...
  ruby: {
    wasmPath: resolvePath(REPO_ROOT, 'vendor/tree-sitter-ruby.wasm'),
    tagsScmPath: resolvePath(here, 'tags/ruby.scm'),
  },
};
